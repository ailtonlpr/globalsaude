                    ...
                    ?>
                      ...
                      <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                          <div class="form-group">
                            <label>Nome</label>
                            <?= $this->Form->text('S_COTACAO_S_NOME', ['class'=>'form-control ipt-custom input-md','placeholder'=>'Insira o Nome']); 
                            ?>
                            <?php
                      ...
                      <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                          <div class="form-group">
                            <label>E-mail</label>
                            <?= $this->Form->text('S_COTACAO_S_EMAIL', ['class'=>'form-control input-md','placeholder'=>'Insira o E-mail']); 
                            ?>
                            <?php
                      ...
                      <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="S_COTACAO_I_NUMERO_MOVEL" id="phonemobile" class="form-control input-md" placeholder="Insira o Número" data-rule="required" data-msg="The phone number is required">
                            <?php
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="S_COTACAO_I_NUMERO_FIXO" id="phone" class="form-control input-md" data-rule="required" placeholder="Insira o Número" data-msg="The phone number is required">
                            <?php
                              if(isset($erros['S_COTACAO_I_NUMEROS'])) {
                                echo $this->PaginasFuncoes->mensErroValidate($erros['S_COTACAO_I_NUMEROS']);
